...
class GraphsPeruMapApp(QMainWindow):
    ...
    def generar_mapa_base(self):
        ...
        from src.visualizacion_mejorada import generar_mapa_base, convertir_pillow_a_qpixmap
    ...
    def mostrar_ruta_en_mapa(self, ruta, distancias_segmentos=None):
        ...
        from src.visualizacion_mejorada import generar_mapa_con_ruta, convertir_pillow_a_qpixmap
